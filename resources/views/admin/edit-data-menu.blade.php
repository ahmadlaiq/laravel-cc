...
<section class="section">
    <div class="section-header">
      <h1>Edit Daftar Menu</h1>
    </div>
    <div class="col-12 col-md-6 col-lg-12">
      <div class="card">
        <div class="card-header">
          <h4>Silahkan Edit Data Daftar Menu</h4>
        </div>
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="kategori" value="{{ $menu->kategori }}">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="deskripsi" value="">{{ $menu->deskripsi }}</textarea>
          </div>
          <div class="form-group">
            <label>Foto</label>
